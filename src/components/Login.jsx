...
const Login = () => {
  /**Atributos a utilizar y eventos de mensaje y tiempo de carga del login*/
...
/**Aqui se establece un evento*/
  const HandleChange = (e) => {
    setInputs({ ...inputs, [e.target.name]: e.target.value });
  };

  const onSubmit = async (e) => {
    /**prevent default es para que la pagina no se reinicie una vez se de clic en el boton*/
    e.preventDefault();
    /**Condicional para los atributos a utilizar */
    if (correo !== "" && contraseña !== "") {
      ...
      setLoading(true);
      /**El puerto correspodiente de login y la tabla donde se almacena los datos en la DB*/
      await axios
        ...
        /**Evento de error en el caso de que los datos sean incorrectos*/
        .catch((error) => {
          console.error(error);
...
/**Estructura grafica del Login donde se tiene en cuenta los eventos*/
  return (
    <>
